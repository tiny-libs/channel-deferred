...
QUnit.module('channel-deferred');

test("Types checking", function () {
	ok(typeof channelDeferred.newInstance === 'function', "Has method new instance");
	ok(typeof channelDeferred === 'function', "It is itself a function");
	ok(typeof channelDeferred.newInstance().newInstance === 'function', "Newly created instance has method new instance");
});

test("Namespace returns reference to deferred", function () {
    var instance = channelDeferred.newInstance();

    ok(instance("namespace") === instance("namespace"), "Is reference");
});

test("Is Promise test", function () {
    var instance = channelDeferred.newInstance();

    ok(isPromise(instance("namespace").promise), "Promise");
});

test("No arguments", function () {
    var instance = channelDeferred();
    var value = 'some_value';

	instance("namespace").resolve(value)(function (res) {
